...
| [TheFrizz](./TheFrizz) | Windows | Medium | Unauthenticated | X |   | Referenced | 3h 35min |2026-09-01
...
- **Solo** — start to finish with my own methodology and research (no AI/walkthrough/video. Web Browsing applies. OSCP like)
...
```
MachineName/
├── README.md          # machine info, repo index, brief and techniques, lesson/takeaway
