...
### Content:
- [**`testing.md`**](https://github.com/cac3r/htb_machines/blob/main/validation/testing.md)                - Raw notes / working log
- [**`report.pdf`**](https://github.com/cac3r/htb_machines/blob/main/validation/report.pdf)                - Professional report
- [**`attack_chain.png`**](https://github.com/cac3r/htb_machines/blob/main/validation/attack_chain.png)   - Attack chain diagram
...
---
### Lesson:
Lesson #1: Try harvested passwords against any known user/service, is cheap and quick, worst case is not valid. For now on will note the credentials on a separate file to have handy to copy paste passwords to check for reuse. 
